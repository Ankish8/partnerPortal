      ...
      <div className="mb-6 flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-bold text-foreground">Conversation Flows</h1>
          </div>
      ...
      <div className="space-y-4">
        {mockFlows.map((flow) => (
          <Card key={flow.id} className="p-5">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted">Intent: {flow.intent} &middot; Edited {flow.lastEdited}</p>
                </div>
              </div>
            ...
            {/* Flow steps */}
            <div className="ml-4 border-l-2 border-default pl-4 space-y-0">
